...
namespace Icecraft
{
    public class IcecraftAgent : Agent
    {
        ...
        [Tooltip("The icecraft mesh that will disappear on explosion")]
        ...
        // Whether the icecraft is frozen (intentionally not flying)
        ...
        public override void InitializeAgent()
        {
            ...
            area = GetComponentInParent<IcecraftArea>();
        ...
        public override void AgentAction(float[] vectorAction, string textAction)
        {
            ...
            if (area.trainingMode)
            {
                ...
                if (localCheckpointDir.magnitude < area.IcecraftAcademy.resetParameters["checkpoint_radius"])
                {
                    GotCheckpoint();
                }
            }
        ...
        /// <summary>
        /// Collects observation used by agent to make decisions
        /// </summary>
       public override void CollectObservations()
        {
            // Observe icecraft velocity (1 vector3 = 3 values)
       ...
       private void OnCollisionEnter(Collision collision)
        ...
        /// <summary>
        /// Resets the icecraft to the most recent complete checkpoint
        /// </summary>
        ...
        private IEnumerator ExplosionReset()
        {
            ...
            // Disable icecraft mesh object, enable explosion
            meshObject.SetActive(false);
            explosionEffect.SetActive(true);
            yield return new WaitForSeconds(2f);

            //Disable explosion, re-enable icecraft mesh
